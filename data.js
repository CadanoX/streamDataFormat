const data = {
	"reference": {
		"timesteps": [
			{ "comment": "for every timestep there exists a tree" },
			{
				"comment": "tree at timestep 0",
				"references": {
					"comment": "reference the nodes in the tree for faster access",
					"1": "pointer to node with id 1",
					"2": "pointer to node with id 2",
					"0": "pointer to node with id 0"
				},
				"tree": {
					"id": 2,
					"size": "10",
					"pos": "0",
					"next": "pointer to node 1 in next timestep",
					"children": [
						{
							"children": [],
							"id": 0,
						...
						},
						{
							...
							"size": "1",
							"pos": "8",
							"next": "pointer to node 0 in next timestep"
						}
					]
				},
				"deleted": {
					"comment": "pointers to nodes, which existed in the previous timestep, but not in this one",
				},
			},
			// Example, where node with ID 0 got deleted and root node got smaller
			{
				"comment": "tree at timestep 1",
				"references": {
					"1": "pointer to node with id 1",
					"0": "pointer to node with id 0"
				},
				//this is the tree at timestep 0
				"tree": {
					"id": 1,
					"size": "10",
					"pos": "0",
					"prev": "pointer to node with id 2 in the previous timestep",
					"children": [
						{
							"children": [],
							"id": 0,
							"size": "1",
							"pos": "8",
							"prev": "pointer to node with id 1 in the previous timestep"
						}
					]
				},
				"deleted": {
					"2": "pointer to node 0s in the previous timestep",
				},
			}
		]
	},
